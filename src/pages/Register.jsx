...
const Register = () => {
  ...
  return (
    <form
      ...
      className="text-lg w-full h-full bg-C_LightBlue flex  flex-col gap-3 items-center justify-center md:w-[60%] md:h-[40%] md:rounded-xl md:gap-3 md:shadow-lg  lg:w-[30%] lg:h-[60%] "
    >
