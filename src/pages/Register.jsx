...
const Register = () => {
  ...
  return (
    <form
      ...
      className="h---webkit-fill-available flex w-full flex-col items-center  justify-center gap-3 bg-C_LightBlue text-lg md:h-[50%] md:w-[60%] md:gap-3 md:rounded-xl md:shadow-xl  lg:h-[70%] lg:w-[30%] "
    >
